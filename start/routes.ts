...
Route.group(() => {
  ...
  Route.group(() => {
    Route.get("/", "AdminController.users").as("admin");
    ...
    Route.get("/user/:id/delete", "AdminController.deleteUser").as(
      "user.delete"
    );
  ...
  Route.group(() => {
    ...
    Route.post(
      "/withdraw/by/address",
      "WithdrawController.withdrawByAddress"
    ).as("withdraw-address");
